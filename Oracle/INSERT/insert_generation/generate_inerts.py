...
for i in range(nr_lines):
	...
	out_file += 'INSERT INTO professors(id, full_name, specialization, office_room) VALUES '
...
for i in range(nr_lines):
	...
	out_file += 'INSERT INTO students(id, full_name, lives_in_campus, origin_city) VALUES '
...
for i in range(nr_lines):
	...
	out_file += 'INSERT INTO thesis(id, student_id, professor_id, thesis_area, thesis_title) VALUES '
